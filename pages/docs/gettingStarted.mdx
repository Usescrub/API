...
**1. Authenticate** — log in for a JWT, or use an API key from Token Management. See [Authentication](/docs/authentication).
...
- [Authentication](/docs/authentication) — signup, JWT, and API keys
